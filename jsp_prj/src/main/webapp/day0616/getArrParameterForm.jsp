  ...
  ================================================== -->
         ...
         <div class="row featurette">
            ...
            <div style="padding-left: 20px">
               <h3>name속성의 값이 중복되는 HTML Form Control 값 받기</h3>
               <div>
               <%
               //input type="text"는 값이 입력되지 않으면 queryString으로 
               //""가 입력되어 생성된다. text=
    ...
    out.println("text 값이 없습니다.");
}

// checkbox는 확인된 것이 없으면 queryString 자체가 생성되지
// 않으므로 null이 입력된다. 
String[] hobby=request.getParameterValues("hobby");

/* ❌ 이 부분이 에러 원인이라 삭제해야 함
for(int i=0; i<text.length; i++){
   out.print("<strong>text: </strong>");
   out.print(text[i]);
   out.println("<br>");
