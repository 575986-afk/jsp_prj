...
<li>요청 서버 URI: <%=request.getRequestURI() %></li>
<li>접속자 servlet: <%=request.getServletPath() %></li>
<li>접속자 parameter: <%=request.getParameter("name") %></li>
<li>접속자 parameter: <%=request.getParameter("age") %></li>
<!-- 이름이 같으면 처음 값만 얻는다 -->
<li>접속자 parameter: <%=request.getParameter("age") %></li>
<!-- 이름이 같으면 배열로 처리한다. -->
<li>접속자 parameter: 
