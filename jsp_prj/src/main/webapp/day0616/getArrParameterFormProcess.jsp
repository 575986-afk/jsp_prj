...
function addText(){
   cnt++;
   $("#txt").append(`<br><input type="text" name="text" value="테스트${cnt}">`);
}
      ...
      <div id="myCarousel" class="carousel slide mb-6"
         ...
         <div class="row featurette">
            ...
            <div style="padding-left: 20px">
               <form action="getArrParameterFormProcess.jsp" method="get" id="frm" onsubmit="return false">
               <table>
               <tr>
               <th colspan="2"><h3>name 속성의 값이 중복되는 HTML Form Control</h3></th>
               </tr>
               <tr>
               <td>text</td>
               <td>
