         ...
         <div class="row featurette">
              ...
              if(cookies!=null){
            	  ...
            	  for(int i=0; i<cookies.length; i++){
            		...
            		if(cookieFlag=!("JSESSIONID".equals(tempCookie.getName()))){
            			cookieFlag=true;
              ...
              //if(cookieFlag){
            	...
            	나이<span><%=cookieAge %></span>  
            	<a href="removeCookie.jsp">쿠키삭제</a> --%>
            	<%
              //}else{
              %>
              <form action="addCookie.jsp" id="frm" method="GET">
              
              <label>이름</label>
            <input type="text" name="name" id="name" value="<%=cookieName%>"/><Br>
              <label>나이</label>
            <input type="text" name="age" id="age" value="<%=cookieAge%>"/><br>
