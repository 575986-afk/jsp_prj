		...
		<div id="myCarousel" class="carousel slide mb-6"
			...
			<div class="row featurette">
				...
				<div style="padding-left: 20px">
					<form action="postArrParameterFormProcess.jsp" name="frm" method="post" id="frm" onsubmit="return false">
					<table>
					<tr>
					<th colspan="2"><h3>name속성의 값이 중복되는 HTML Form Control(POST방식)</h3></th>
					</tr>
					<tr>
					<td>text</td>
					<td>
