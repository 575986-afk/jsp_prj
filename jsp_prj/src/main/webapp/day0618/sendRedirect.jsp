...
<%@ page language="java" contentType="text/html; charset=UTF-8"
   pageEncoding="UTF-8"%>
<%
//특정 ip로 요청 되면 다른 site로 이동.
String ip=request.getRemoteAddr();

String[] blockedIp={"192.168.10.70","192.168.10.87","192.168.10.74"};

boolean moveFlag=false;

for(int i=0; i<blockedIp.length; i++){
	if((ip.equals(blockedIp[i]))){
		break;
	}
}
...
//페이지를 이동하더라도 아랫줄의 코드를 실행하면서 이동을 한다.
return;
}
%>
<!DOCTYPE html>
...
<link href="http://192.168.10.68/jsp_prj/common/css/bootstrap.min.css" rel="stylesheet"
   >
...
<body>
  ...
  ================================================== -->
         ...
         <div class="row featurette">
            <div class="col-md-7">
               ...
               %>
                  ...
                  <span class="<%= color %>"><%= request.getMethod() %></span>
                  </span>
               </h2>
   ...
   <script src="http://192.168.10.68/jsp_prj/common/js/bootstrap.bundle.min.js"
