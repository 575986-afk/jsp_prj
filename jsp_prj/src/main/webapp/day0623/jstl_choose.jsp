...
<body>
  ...
  ================================================== -->
      ...
      <div>
      <c:choose>
      <c:when test="${param.role=='guest' }">읽기 | 쓰기</c:when>
      <c:when test="${param.role=='user'}">읽기 | 쓰기 | 삭제 | 변경</c:when>
      ...
      <a href="jstl_if.jsp?role=guest">손님</a>
      <a href="jstl_if.jsp?role=guest">사용자</a>
      <a href="jstl_if.jsp?role=guest">관리</a>
