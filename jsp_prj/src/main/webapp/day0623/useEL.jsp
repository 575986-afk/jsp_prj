      ...
      <div class="container marketing">
         ...
         <%
         	...
         	int year=2026;
          	...
          	int day=23;
          	int hour=9;
          	//2. 변수의 값을 EL에서 사용하기 위해 scope객체에 설정
         ...
         <!-- scope 객체의 이름과 동일한 이름이 들어가 있을 때 scope 객체명을 생랴갛면 
         접근이 작은 scope객체에 값을 가져다 사용한다. -->
         ...
         논리 : ${year > month && day>month}(${year ne month and day gt month})<br>
          ${year > month || day>month}(${year ne month or day gt month})<br>
