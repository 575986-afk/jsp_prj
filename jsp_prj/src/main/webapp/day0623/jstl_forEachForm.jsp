...
<body>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			<!-- 폼 태그에 액션 속성을 정의하지 않으면 submit이 되었을 때
         자신의 페이지를 재요청하게 된다. -->
			<form method="post">
				<label>이름</label><input type="name" name="name" value="테스트" /> <br>
				<label>관심언어</label>
				<%
         ...
         <c:if test="${i.first or i.last }">
			...
			<div>
				...
				<c:if test="${not empty param.name }">
					<!-- web parameter에 name값이 존재하면 선택된 checkbox의 값을 출력 -->
	...
	<script
		src="http://localhost/jsp_prj/common/js/bootstrap.bundle.min.js"
